# dotfiles-wallpapers/src/dotfiles_wallpapers/api/wallpapers.py
"""Python API for wallpaper management."""
from pathlib import Path
from typing import List, Optional

from dotfiles_wallpapers.services.wallpapers_service import WallpapersService
...
class Wallpapers:
    ...
    def _default_archive_path() -> Path:
        ...
        Returns:
            Path to dotfiles-wallpapers/wallpapers.tar.gz
        """
        package_dir = Path(__file__).parent.parent.parent.parent
        return package_dir / "wallpapers.tar.gz"
