# dotfiles-packages/src/dotfiles_packages/services/packages_service.py
...
class PackagesService:
    ...
    def __init__(
        ...
        Args:
            playbook_path: Path to Ansible playbook (defaults to dotfiles-packages/ansible/playbooks/bootstrap.yml)
            ansible_dir: Path to ansible directory (defaults to dotfiles-packages/ansible)
        """
        if playbook_path is None:
            project_root = Path.cwd()
            playbook_path = project_root / "dotfiles-packages" / "ansible" / "playbooks" / "bootstrap.yml"
